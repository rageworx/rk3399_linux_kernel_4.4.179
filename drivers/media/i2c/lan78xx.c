...
#define DRIVER_VERSION  "1.0.6.4.4.1.0"
...
#ifndef SUPPORT_ETHTOOL_LINK_KSETTING
static int lan78xx_get_settings(struct net_device* net,
...
#ifndef SUPPORT_ETHTOOL_LINK_KSETTING
static int lan78xx_set_settings(struct net_device* net,
                                struct ethtool_cmd* cmd )
#else
...
#endif
{
    ...
    /* change speed & duplex */
    ret = phy_ethtool_sset(phydev, (struct ethtool_cmd*)cmd);
             ...
             const struct usb_device_id *id)
{
    ...
    printk( "== Microchip LAN78XX USB GbE adapter driver probe ==\n" );
    printk( "== .. raphael.kim, rageworx@gmail.com             ==\n" );
